...
# [!DNL Workfront]Actualizaciones de mantenimiento en 2022
...
+++**Actualización de mantenimiento realizada el 15 de diciembre de 2022**
...
* Las casillas de verificación de las listas ahora tienen un indicador de enfoque visible cuando se les aplica la tabulación. Esto hace que sea más fácil seguir visualmente la navegación con teclado por los elementos de una lista.
...
* Anteriormente, al abrir un menú desplegable en una lista con la barra espaciadora, se abría el menú y la página también se desplazaba hacia abajo un poco, algo que no estaba previsto. Ahora la página ya no se desplaza al pulsar la barra espaciadora en una lista desplegable, que es el comportamiento previsto y correcto.
* Al ver una lista con la casilla de verificación de fila seleccionada, ahora puede tabular en cada elemento editable y, a continuación, pulsar la barra espaciadora para cambiar al modo de edición y comenzar a editar esa celda de la fila. Anteriormente, estos elementos no eran navegables mediante el teclado y era necesario el uso de un ratón. Ahora, se puede cambiar al modo de edición con el ratón y el teclado.

**Error “[!UICONTROL ¡Uy!]” al crear un proyecto a partir de una plantilla**
...
**El gráfico combinado muestra los mismos datos dos veces**
...
**Se ha añadido información sobre herramientas en las celdas de hora atenuadas de la plantilla de horas**

*Plantillas de horas*

Se ha añadido información de herramientas para explicar el motivo por el que una celda de hora puede estar atenuada en una plantilla de horas. Por ejemplo, podría deberse a que la plantilla de horas está cerrada o a que el proyecto se ha completado.
...
**No se pueden introducir las horas en la plantilla de horas**
...
+++**Actualización de mantenimiento realizada el 8 de diciembre de 2022**

**Selección inteligente de usuarios al añadir aprobadores a una ruta de aprobación**

*Rutas de aprobación*

Hemos mejorado la forma en que se muestran los usuarios al agregarlos al campo [!UICONTROL Aprobadores] de una nueva aprobación.

Ahora, cuando agregue un usuario al campo [!UICONTROL Aprobadores] de una aprobación de un solo uso o de nivel de sistema, además de su nombre y avatar, también se mostrarán su función principal y su correo electrónico. Esto ayuda a distinguir entre varios usuarios con nombres similares o idénticos.
...
>[!NOTE]
>
>Esta actualización solo se ha publicado en el entorno de vista previa. Se lanzará al entorno de producción con la versión 23.1.
...
“&lt;Nombre> no coincide con la función de &lt;Asignación de función de tarea>. 1 elemento de trabajo asignado actualmente a la función &lt;Asignación de función de tarea> se asignará a &lt;Nombre> en la función de &lt;Rol principal>.”
