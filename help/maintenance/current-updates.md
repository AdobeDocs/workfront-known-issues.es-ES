...
Esta actualización contiene solo correcciones de errores menores o menos importantes. El Soporte técnico de Workfront le avisará cuando haya solucionado un problema enviado por usted.
...
**Lista de campos del Editor de cálculos limitada a 200 elementos**

En el Editor de cálculos para campos calculados en formularios personalizados, la lista de campos para un objeto está limitada ahora a 200 elementos para mejorar el rendimiento del sistema. Si conoce el nombre del campo, puede buscarlo utilizando la opción de escritura anticipada en lugar de desplazarse por la lista.
...
**No se puede reactivar el usuario**
...
**La lista desplegable se cierra al seleccionar varios valores**
...
**El informe no se carga cuando la moneda predeterminada es USD**
...
+++**Actualización de mantenimiento el viernes, 20 de junio de 2024**
...
**No se pueden editar horas en tareas o problemas**
...
**Discrepancia en horas presupuestadas**
...
**Los comentarios del documento no aparecen en las actualizaciones del objeto principal**
...
**Etiquetar a un usuario no es eficaz**
...
**Error de tiempo de ejecución con respuesta 200 del módulo Workfront**
