...
**Las opciones de edición y configuración se han eliminado del menú Más en un tipo de registro**
...
**No se puede guardar al editar un programa**
...
**No se puede editar la configuración de notificaciones para otro usuario**
...
**La búsqueda avanzada no devuelve los resultados esperados**
