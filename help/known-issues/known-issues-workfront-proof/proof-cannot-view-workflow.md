...
description: Mientras están en la página  [!DNL ProofHQ] [!UICONTROL Panel de control], los usuarios no pueden expandir el flujo de trabajo de Prueba desde la lista Prueba en la página del tablero. Cuando un usuario hace clic en el botón de expansión, el botón no responde.
