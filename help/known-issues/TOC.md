...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas actuales en [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Programas: Problemas al asignar un [!UICONTROL Propietario del programa]](known-issues-workfront/wf-programs-issues-assigning-program-manager.md)
      ...
      + [Agile: Problemas con las tareas agregadas a una iteración](known-issues-workfront/wf-agile-issues-with-tasks-on-iteration.md)
      ...
      + [Plantillas de horas: No se pueden introducir horas en [!UICONTROL Hora general]](known-issues-workfront/wf-timesheets-general-time-disabled.md)
      + [Listas: El [!UICONTROL Filtro rápido] no devuelve resultados al buscar equipos](known-issues-workfront/wf-lists-no-results-for-teams-in-quick-filter.md)
      + [Navegación: No se puede volver a anclar una página tras haber eliminado su fijador](known-issues-workfront/wf-navigation-undo-pin-does-not-replace-pin.md)
      + [Asignaciones: Error al asignar un equipo por lotes](known-issues-workfront/wf-assignments-error-when-bulk-assigning-team.md)
      + [Tareas: El icono [!UICONTROL Predecesor] no se encuentra en el encabezado de la tarea](known-issues-workfront/wf-tasks-predecessor-icon-missing-from-header.md)
      ...
      + [Tareas y problemas: No se puede editar el nombre o el porcentaje completado de una tarea o un problema](known-issues-workfront/wf-tasks-issues-cannot-edit-name-percent.md)
      ...
      + [Documentos: Error de tipo “[!UICONTROL No se pudo cargar el archivo]”](known-issues-workfront/wf-documents-failed-to-upload-file.md)
      ...
      + [Plantillas de horas: Las horas no se guardan al utilizar el [!UICONTROL tabulador]](known-issues-workfront/wf-timesheets-hours-do-not-save-when-using-tab.md)
