...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas actuales en [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Solicitudes: No se puede cargar un documento al rellenar una solicitud](known-issues-workfront/wf-request-cannot-submit-with-document.md)
      + [Solicitudes: Aparece &quot;Sin asunto&quot; en la lista de solicitudes](known-issues-workfront/wf-requests-no-subject.md)
      + [Formularios personalizados: la lógica de visualización no se muestra correctamente en el formulario de solicitud](known-issues-workfront/wf-custom-forms-display-logic-not-triggering.md)
      + [Inicio de sesión: Workfront no se carga después del inicio de sesión](known-issues-workfront/wf-login-wf-does-not-load.md)
      + [Distribuidor de cargas de trabajo: las horas por usuario no se calculan correctamente](known-issues-workfront/wf-workload-balancer-hours-per-user-not-correct.md)
      + [Documentos: El panel de resumen está en blanco](known-issues-workfront/wf-documents-summary-panel-is-blank.md)
      + [Solicitudes: Error &quot;No cuenta con acceso suficiente&quot; al copiar solicitudes](known-issues-workfront/wf-requests-do-not-have-sufficient-access.md)
      + [Programas: No se pueden ver excepciones de años anteriores](known-issues-workfront/wf-schedules-cannot-see-previous-year-exceptions.md)
      ...
      + [Solicitudes: problemas con los borradores en la nueva experiencia de solicitud](known-issues-workfront/wf-requests-issues-with-drafts.md)
      + [Solicitudes: las colas de solicitudes aparecen varias veces](known-issues-workfront/wf-requests-queues-duplicated.md)
      + [Usuarios: no se puede actualizar el acceso del usuario](known-issues-workfront/wf-users-no-access-to-view-finance-when-changing-access.md)
      ...
      + [Creación de informes: los usuarios pueden ver los datos financieros en las visualizaciones del panel de lienzo](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Workfront Planning: no se puede añadir un campo a una vista](known-issues-workfront/wf-planning-cannot-add-field.md)
      ...
      + [Workfront Planning: error al eliminar un campo conectado](known-issues-workfront/wf-planning-cannot-delete-connected-field.md)
      + [Usuarios: falta la opción para generar automáticamente las pruebas en el perfil de usuario](known-issues-workfront/wf-users-no-option-to-automatically-generate-proofs.md)
      ...
      + [Tareas: No se puede seleccionar la función de usuario al crear una tarea](known-issues-workfront/wf-tasks-cannot-assign-user-role.md)
      ...
      + [Solicitudes: los permisos no se heredan al crear una solicitud](known-issues-workfront/wf-requests-permissions-not-inherited.md)
      ...
      + [Asignaciones: las asignaciones de equipo no se guardan](known-issues-workfront/wf-assignments-not-saved.md)
      ...
      + [Plantillas de horas: las plantillas de horas no se generaban](known-issues-workfront/wf-timesheets-not-generated.md)
      ...
      + [Solicitudes: el creador del formulario de solicitud no tiene acceso a este](/help/known-issues/known-issues-workfront/wf-requests-creator-does-not-have-access-to-form.md)
      + [Usuarios: solo se pueden buscar puestos de trabajo por la primera palabra](known-issues-workfront/wf-users-job-role-first-word.md)
      + [Informes: Problemas relacionados con los menús desplegables en gráficos](known-issues-workfront/wf-reports-dropdown-not-working.md)
      ...
      + [Pruebas: no se puede cerrar el visor de pruebas](known-issues-workfront/wf-cannot-close-proofing-viewer.md)
      ...
      + [Pruebas: no se puede generar una prueba desde un archivo PowerPoint](known-issues-workfront/wf-proofs-cannot-generate-from-pptx.md)
      + [Usuarios: no se puede editar la configuración de notificaciones de otro usuario](known-issues-workfront/wf-users-cannot-edit-another-users-notifications.md)
      ...
      + [Pruebas: no se pueden añadir usuarios a una prueba por su nombre en el entorno de vista previa](known-issues-workfront/wf-proofs-cannot-add-users-by-name-in-preview.md)
      + [Usuarios: el distintivo “Aprobación pendiente” se muestra en los usuarios nuevos](known-issues-workfront/wf-users-pending-approval.md)
      + [Pruebas: al cerrar la prueba, se redirige a la lista de documentos](known-issues-workfront/wf-proofs-x-goes-to-doc-list.md)
      + [Documentos: no se muestran las miniaturas del documento](known-issues-workfront/wf-documents-thumbnails-not-display.md)
      + [Filtros: La lista desplegable desaparece al hacer clic en la barra de desplazamiento](known-issues-workfront/wf-filter-scroll-bar.md)
      + [Proyectos: el estado de progreso del proyecto no se actualiza automáticamente a Retrasado](/help/known-issues/known-issues-workfront/wf-projects-inaccurate-condition.md)
      ...
      + [Prioridades: las agrupaciones impiden la ordenación y la edición en línea](known-issues-workfront/wf-home-priorities-grouping-limitations.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Problemas actuales en [!DNL Workfront Proof] {#proof-current}
      + [Workfront Proof: Las pruebas no aparecen en las carpetas](known-issues-workfront-proof/proof-folders-not-showing-proofs.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemas actuales en [!DNL Workfront Fusion] {#fusion-current}
      ...
      + [Workfront Fusion: el módulo de búsqueda de Jira devuelve un error](known-issues-workfront-fusion/fusion-error-in-jira-search.md)
      + [Workfront Fusion: las actualizaciones del webhook no se guardan automáticamente](/help/known-issues/known-issues-workfront-fusion/fusion-must-save-updated-webhook.md)
