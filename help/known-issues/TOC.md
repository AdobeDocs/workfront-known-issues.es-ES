...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemas actuales en [!DNL Workfront Fusion] {#fusion-current}
      + [Workfront Fusion: Falta el error de encabezado en los módulos de AWS](known-issues-workfront-fusion/fusion-missing-header-aws.md)
...
+ Planificación de [!DNL Workfront] {#planning}
