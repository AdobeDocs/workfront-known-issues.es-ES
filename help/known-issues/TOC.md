...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas actuales en [!DNL Adobe Workfront] {#wf-current}
      + [Documentos: el panel de resumen está en blanco](known-issues-workfront/wf-documents-summary-panel-is-blank.md)
      + [Solicitudes: error &quot;No tiene acceso suficiente&quot; al copiar solicitudes](known-issues-workfront/wf-requests-do-not-have-sufficient-access.md)
      + [Horarios: No se pueden ver excepciones de años anteriores](known-issues-workfront/wf-schedules-cannot-see-previous-year-exceptions.md)
      + [Solicitudes: &quot;Todas&quot; vista no muestra todas las solicitudes](known-issues-workfront/wf-requests-not-showing-all.md)
      ...
      + [Solicitudes: el borrador creado junto con solicitud causa problemas](known-issues-workfront/wf-requests-draft-created-with-request.md)
      ...
      + [Usuarios: los usuarios no se aprovisionan correctamente en la Adobe Admin Console](known-issues-workfront/wf-users-on-other-consoles-not-provisioning.md)
      + [Solicitudes: problemas con borradores en la nueva experiencia solicitante](known-issues-workfront/wf-requests-issues-with-drafts.md)
      + [Solicitudes: las colas de solicitudes aparecen varias veces](known-issues-workfront/wf-requests-queues-duplicated.md)
      + [Usuarios: no se puede actualizar usuario acceso](known-issues-workfront/wf-users-no-access-to-view-finance-when-changing-access.md)
      + [Informes: la consulta de Data Lake no devuelve los resultados esperados](known-issues-workfront/wf-reports-data-lake-not-return-expected-results.md)
      + [Informes: los usuarios pueden ver datos financieros en las visualizaciones del tablero de Canvas](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Planificación del frente de trabajo: no se puede agregar un campo a una vista](known-issues-workfront/wf-planning-cannot-add-field.md)
      ...
      + [Planificación del frente de trabajo: Error al eliminar el campo conectado](known-issues-workfront/wf-planning-cannot-delete-connected-field.md)
      + [Usuarios: Falta la opción de generar pruebas automáticamente en usuario perfil](known-issues-workfront/wf-users-no-option-to-automatically-generate-proofs.md)
      ...
      + [Usuarios: Error al abrir la Página de usuarios](known-issues-workfront/wf-users-cannot-open-user-tab.md)
      + [Tareas: no se puede seleccionar usuario función al crear un tarea](known-issues-workfront/wf-tasks-cannot-assign-user-role.md)
      + [Pruebas: los cambios de estado de la prueba se retrasan](known-issues-workfront/wf-proof-status-sync-delayed.md)
      + [Tareas: las ediciones en línea de un tarea no se guardan](known-issues-workfront/wf-tasks-inline-changes-not-saving.md)
      + [Usuarios: la edición masiva de usuarios elimina los grupos de recursos y dirige los informes](known-issues-workfront/wf-users-bulk-editing-clears-resource-pools.md)
      + [Solicitudes: no se puede cargar documento a solicitud desde GDrive](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md)
      + [Tareas: las ediciones de la sección Asignaciones de una tarea no se guardan](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md)
      ...
      + [Solicitudes: permisos no heredados al crear un solicitud](known-issues-workfront/wf-requests-permissions-not-inherited.md)
      + [Programas: se han revocado los permisos para programar un grupo](known-issues-workfront/wf-schedules-group-permissions-revoked.md)
      + [Asignaciones: las asignaciones del equipo no se guardan](known-issues-workfront/wf-assignments-not-saved.md)
      + [Tareas: no se guardaban las horas planificadas al crear tarea](known-issues-workfront/wf-tasks-planned-hours-not-saving.md)
      + [Partes de horas: partes de horas no generadas](known-issues-workfront/wf-timesheets-not-generated.md)
      + [Tareas: mensaje &quot;Acceso insuficiente&quot; cuando se realizan tareas de edición en línea](known-issues-workfront/wf-tasks-insufficent-access-to-edit.md)
      + [Aprobaciones: Enlaces a aprobaciones no disponibles](known-issues-workfront/wf-approvals-link-not-appearing.md)
      + [Solicitudes: el creador del formulario de solicitud no tiene acceso al formulario](/help/known-issues/known-issues-workfront/wf-requests-creator-does-not-have-access-to-form.md)
      + [Usuarios: solo pueden búsqueda puestos de trabajo por primera palabra](known-issues-workfront/wf-users-job-role-first-word.md)
      + [Informes: problemas relacionados con las listas desplegables en los gráficos](known-issues-workfront/wf-reports-dropdown-not-working.md)
      + [Usuarios: no se pueden utilizar opciones avanzadas al crear usuarios](/help/known-issues/known-issues-workfront/wf-users-cannot-use-advanced-options.md)
      ...
      + [Aprobaciones: los botones de decisión de aprobación no se muestran en el visor de pruebas](known-issues-workfront/wf-approvals-decision-buttons-not-in-proof-viewer.md)
      + [Aprobaciones: la aprobación se muestra como &quot;Sin fecha límite&quot; cuando la hora no se incluye en la fecha límite](/help/known-issues/known-issues-workfront/wf-approvals-displays-no-deadline-if-no-time.md)
      + [Pruebas: no se puede generar un prueba a partir de un archivo de PowerPoint.](known-issues-workfront/wf-proofs-cannot-generate-from-pptx.md)
      + [Usuarios: no se puede editar la configuración de notificaciones para otro usuario](known-issues-workfront/wf-users-cannot-edit-another-users-notifications.md)
      + [Usuarios: no se puede editar el ID de federación de un usuario.](/help/known-issues/known-issues-workfront/wf-users-cannot-edit-fed-id.md)
      + [Permisos: los permisos de objeto no se heredan correctamente](known-issues-workfront/wf-permissions-not-inherited-correctly.md)
      + [Workfront: objetos fuera de sincronizar entre Workfront y Snowflake](/help/known-issues/known-issues-workfront/wf-users-deactivated-appear-in-snowflake.md)
      + [Pruebas: no se pueden agregar usuarios a un prueba por nombre en el entorno de Vista previa](known-issues-workfront/wf-proofs-cannot-add-users-by-name-in-preview.md)
      + [Usuarios: aparece el distintivo &quot;Pendiente de aprobación&quot; en los nuevos usuarios](known-issues-workfront/wf-users-pending-approval.md)
      + [Pruebas: cierre prueba redireccionamientos a documentos lista](known-issues-workfront/wf-proofs-x-goes-to-doc-list.md)
      + [Documentos: las miniaturas de documentos no se muestran](known-issues-workfront/wf-documents-thumbnails-not-display.md)
      + [Filtros: El menú desplegable desaparece al hacer clic en la barra de desplazamiento](known-issues-workfront/wf-filter-scroll-bar.md)
      + [Proyectos: el estado de progreso del proyecto no se actualiza automáticamente a Tarde](/help/known-issues/known-issues-workfront/wf-projects-inaccurate-condition.md)
      ...
      + [Documentos: no se pueden cargar en la lista de documentos de la carpeta de AEM](/help/known-issues/known-issues-workfront/wf-documents-cannot-upload-to-aem-folder.md)
      + [Revisiones: no se pueden etiquetar a determinados usuarios](/help/known-issues/known-issues-workfront/wf-proofs-cannot-tag-users.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Problemas actuales en [!DNL Workfront Proof] {#proof-current}
      + [Prueba de frente de trabajo: las pruebas no aparecen en las carpetas](known-issues-workfront-proof/proof-folders-not-showing-proofs.md)
   ...
   + Problemas resueltos en [!DNL Workfront] la prueba {#proof-resolved}
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemas actuales en [!DNL Workfront Fusion] {#fusion-current}
      + [Workfront Fusion: error de encabezado faltante en los módulos de AWS](known-issues-workfront-fusion/fusion-missing-header-aws.md)
      + [Workfront Fusion: Jira Search módulo devuelve un error](known-issues-workfront-fusion/fusion-error-in-jira-search.md)
      + [Workfront Fusion: Las actualizaciones de webhook no se guardan automáticamente](/help/known-issues/known-issues-workfront-fusion/fusion-must-save-updated-webhook.md)
...
+ [!DNL Workfront] Planificación {#planning}
   + [Problemas conocidos en [!DNL Workfront] la planificación](workfrontplanning.md)
