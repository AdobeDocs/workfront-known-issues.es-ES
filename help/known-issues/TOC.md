...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas actuales en [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Plantillas de horas: las horas no se guardan al utilizar la tecla de [!UICONTROL tabulación]](known-issues-workfront/wf-timesheets-hours-do-not-save-when-using-tab.md)
      ...
      + [Informes: problemas al crear y editar informes en [!UICONTROL el creador de informes]](known-issues-workfront/wf-reports-builder-degraded-performance.md)
      ...
      + [Formularios personalizados: no se pueden editar los formularios personalizados debido a un campo de [!UICONTROL texto descriptivo]](known-issues-workfront/wf-cust-form-descr-text-label-error.md)
      ...
      + [[!UICONTROL Inicio]: problemas con el resumen de [!UICONTROL Inicio] cuando se usan navegadores distintos a [!DNL Chrome]](known-issues-workfront/wf-home-summary-issues-when-not-using-chrome.md)
   ...
   + Problemas resueltos en [!DNL Adobe Workfront] {#wf-resolved}
      ...
      + [Tareas: no se puede seleccionar el tiempo [!UICONTROL transcurrido] cuando se edita en línea la duración de la tarea](known-issues-workfront/resolved-issues-wf/wf-tasks-cannot-select-elapsed-time.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Problemas actuales en [!DNL Workfront Proof] {#proof-current}
      ...
      + [Las opciones de usuario no se pueden modificar tras la configuración inicial en las plantillas de flujo de trabajo](known-issues-workfront-proof/user-options-cannot-be-modified-after-initial-configuration.md)
      ...
      + [Se muestra una fecha límite de aprobación de pruebas inexacta en la Lista de trabajoss en Inicio](known-issues-workfront-proof/inaccurate-proof-approval-deadline-displayed.md)
   ...
   + Problemas resueltos en [!DNL Workfront] Prueba {#proof-resolved}
      ...
      + [El usuario no puede pasar a otra etapa de una prueba](known-issues-workfront-proof/resolved-issues-proof/user-cannot-move-self-to-another-stage-of-a-proof.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemas actuales en [!DNL Workfront Fusion] {#fusion-current}
      + [[!DNL Workfront Fusion]: Error al ver un error en un historial de ejecución de escenario](known-issues-workfront-fusion/fusion-enoent-error-when-viewing-error.md)
      ...
      + [[!DNL Workfront Fusion] los enlaces de ayuda en la aplicación no conducen a páginas de ayuda específicas](known-issues-workfront-fusion/help-links-in-modules-not-working.md)
   + Problemas resueltos en [!DNL Workfront Fusion] {#fusion-resolved}
      + [Error 401 en módulos [!DNL Workfront] ](known-issues-workfront-fusion/resolved-issues-fusion/401-error-on-workfront-modules.md)
