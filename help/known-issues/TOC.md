...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas actuales en [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Aprobaciones: el widget Mis aprobaciones muestra las pruebas que no se encuentran en la fase a la que está asignado el usuario](known-issues-workfront/wf-approvals-widget-showing-stage-not-started.md)
