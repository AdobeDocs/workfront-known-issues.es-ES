...
Si es redactor técnico, administrador de programa o desarrollador del equipo de producto de un [!DNL Adobe Experience Cloud] y es su trabajo contribuir o crear artículos técnicos, debe utilizar el repositorio privado en `https://git.corp.adobe.com/AdobeDocs`.
