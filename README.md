...
Si es redactor técnico, administrador de programa o desarrollador del equipo de producto para una solución de [!DNL Adobe Experience Cloud] y debe contribuir o crear artículos técnicos, debe utilizar el repositorio privado de `https://git.corp.adobe.com/AdobeDocs`.
